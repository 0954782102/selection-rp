...
$tableconf = array(
    ...
    'TABLE_NAME' => 'NickName', // Таблица с логинами
    'TABLE_PASSWORD' => 'Password', //Таблица с паролями
    'TABLE_MAIL' => 'Email', //Таблица с почтой
    ...
    //'MAX_ADMINLVL' => 7 //Максимальный уровень админки! Игроки с этим уровнём могут входить в админ панель

);

/*
 * Список серверов по которым работает сайт!
 * Можно указать неограниченое кол-во серверов!
 *
 ...
 *
 * Вы можете указать для серверов одинаковые данные от базы!
 */
$servers = array(
     "Mars" => array(
        "IP" => "176.32.37.19",
