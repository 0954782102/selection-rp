...
<div id="content">
    <div class="container">
        <div class="row">
            <h1 class="title wow fadeIn" style="visibility: visible; animation-name: fadeIn;">Бізнес:  <?php echo $biz[$tableconf['TABLE_BIZ_NAME']]; ?></h1>
            ...
            <div class="darkBlock wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-4">
                            <p><small>Вхід у бізнес</small></p>
                            <p><i class="fa fa-<?php echo ($biz[$tableconf['TABLE_BIZ_LOCK']] == 1) ? "lock" : "unlock" ;?>"></i></p>
                        </div>
                        <center><h3 class="blockTitle wow fadeIn" style="visibility: visible; animation-name: fadeIn;">Інформація бізнесу</h3></center>
                        <div class="col-xs-3">
                            <p><small>Ціна за вхід</small></p>
                            <p><span class="fontnumb"><?php echo $biz[$tableconf['TABLE_BIZ_ENTER_COST']];?>$</span></p>
                        </div>
                        <div class="col-xs-3">
                            <p><small>Ціна за продукти</small></p>
                            <p><span class="fontnumb"><?php echo $biz[$tableconf['TABLE_BIZ_PRICEPROD']];?>$</span></p>
                        </div>
                        <div class="col-xs-3">
                            <p><small>Банківський рахунок бізнесу</small></p>
                            <p><span class="fontnumb"><?php echo $biz[$tableconf['TABLE_BIZ_CASH']];?>$</span></p>
                        </div>
                        <div class="col-xs-3">
                            <p><small>У магазині / На складі</small></p>
            ...
            <div class="col-xs-12">
                <div class="darkBlock wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                    <div class="row">
                        <div class="col-md-7">Умови оплати Бізнесу:<br>
                            - Бізнес не виставлений на продаж державі.
                            <br>- При оффлайн оплаті, ціна збільшується на X2.
                            <br>- Оффлайн оплата доступна на 10 днів, при умові, що залишок 10 днів чи менше.
                        </div>
                        <div class="col-md-5">Ціни оплати на 10 днів:<br>
                            Бар: 34.000$ - Ріелт.: 80.000$ - 24x7: 70.000$<br>
                            ГАЗ: 110.000$ - CL BELL: 44.000$ - Ферма: 240.000$<br>
                            BINKO: 102.000$ - СТО: 300.000$ - АЗС: 140.000$<br>
                            Магазин меблі: 160.000$ - Автосалон: 300.000$
                        </div>
                    </div>
                </div></div>
            <form method="post"><input type="hidden" name="token" value="55121"><center><button type="sumbit" name="biz" class="doButton"><i class="fa fa-money" aria-hidden="true"></i> Оплатити оффлайн</button></center></form>
        </div>
    </div>
</div>
<script>
